...
export const GETProductsByKeywordURL = `${baseURL}/${apiVersion}/products/search?keyword=`;
export const GETReviewsForProductURL = (productId: string) => `${baseURL}/${apiVersion}/products/${productId}/reviews`;
