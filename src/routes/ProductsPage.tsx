        ...
        <div className="overflow-auto">
            <div className="grid grid-cols-4 gap-x-0 gap-y-16">
                {products.map((product, index) => (
                    <div className={`card w-96 mx-auto bg-white shadow-xl rounded-2xl ${index < 4 ? "mt-8" : ""} ${ index >= lastProductRowIndex ? "mb-8" : ""}`}>
                        <figure className="h-60 overflow-hidden m-4"><img src={product.imageUrl} className="max-w-full max-h-full" alt="Shoes" /></figure>
                        <div className="card-body bg-primary rounded-b-2xl">
                            ...
                            <div className="card-actions justify-end">
                                <div className="flex items-center justify-between w-full">
                                    ...
                                    <button className="btn btn-primary bg-secondary">Buy</button>
                                </div>
                            </div>
                        </div>
                    </div>
